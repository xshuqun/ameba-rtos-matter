...
To begin building Matter for specific ICs, refer to the detailed instructions provided in the [Matter Building Guide](docs/matter_building_guide.md). Each supported IC has its own building method documented there.
