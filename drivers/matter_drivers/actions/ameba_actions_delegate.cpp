...
namespace {
std::unique_ptr<Clusters::Actions::AmebaActionsDelegateImpl> sAmebaActionsDelegateImpl;
std::unique_ptr<Clusters::Actions::ActionsServer> sAmebaActionsServer;
} // namespace
...
AmebaActionsDelegateImpl * Actions::GetActionsDelegate(void)
{
    return sAmebaActionsDelegateImpl.get();
}

ActionsServer * Actions::GetActionsServer(void)
{
    return sAmebaActionsServer.get();
}

void Actions::SetActionsDelegate(AmebaActionsDelegateImpl * delegate)
{
    // set new pointer and clears old object
    sAmebaActionsDelegateImpl.reset(delegate);
}

void Actions::SetActionsServer(ActionsServer * server)
{
    sAmebaActionsServer.reset(server);
}
