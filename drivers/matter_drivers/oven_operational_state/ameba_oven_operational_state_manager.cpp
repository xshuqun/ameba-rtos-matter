...
AmebaOvenCavityOperationalStateDelegate * OvenCavityOperationalState::GetOvenCavityOperationalStateDelegate(void)
{
    return gAmebaOvenCavityOperationalStateDelegate;
}

void OvenCavityOperationalState::SetOvenCavityOperationalStateDelegate(AmebaOvenCavityOperationalStateDelegate * delegate)
{
    gAmebaOvenCavityOperationalStateDelegate = delegate;
}

OvenCavityOperationalState::Instance * OvenCavityOperationalState::GetOvenCavityOperationalStateInstance(void)
{
    return gAmebaOvenCavityOperationalStateInstance;
}

void OvenCavityOperationalState::SetOvenCavityOperationalStateInstance(Instance * instance)
{
    gAmebaOvenCavityOperationalStateInstance = instance;
}

void OvenCavityOperationalState::Shutdown(void)
{
