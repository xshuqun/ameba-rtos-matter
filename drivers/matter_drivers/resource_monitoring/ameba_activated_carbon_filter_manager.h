...
chip::app::Clusters::ResourceMonitoring::Instance * GetInstance();
void SetInstance(chip::app::Clusters::ResourceMonitoring::Instance * instance);
ActivatedCarbonFilterMonitoringDelegate * GetDelegate();
void SetDelegate(ActivatedCarbonFilterMonitoringDelegate * delegate);
