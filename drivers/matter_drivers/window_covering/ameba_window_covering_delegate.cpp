...
#include <window_covering/ameba_window_covering_delegate.h>
...
Clusters::WindowCovering::AmebaWindowCoveringDelegate sAmebaWindowCoveringManager;

} // namespace

void AmebaWindowCoveringDelegate::Init(EndpointId endpoint)
{
...
void AmebaWindowCoveringDelegate::HandleLiftMovementTimer(System::Layer * layer, void * aAppState)
{
    AmebaWindowCoveringDelegate * manager = reinterpret_cast<AmebaWindowCoveringDelegate *>(aAppState);
...
void AmebaWindowCoveringDelegate::HandleTiltMovementTimer(System::Layer * layer, void * aAppState)
{
    AmebaWindowCoveringDelegate * manager = reinterpret_cast<AmebaWindowCoveringDelegate *>(aAppState);
...
CHIP_ERROR AmebaWindowCoveringDelegate::HandleMovement(WindowCoveringType type)
{
...
CHIP_ERROR AmebaWindowCoveringDelegate::HandleStopMotion()
{
    DeviceLayer::SystemLayer().CancelTimer(HandleLiftMovementTimer, this);
    DeviceLayer::SystemLayer().CancelTimer(HandleTiltMovementTimer, this);
    return CHIP_NO_ERROR;
...
{
    sAmebaWindowCoveringManager.Init(endpoint);
    Clusters::WindowCovering::SetDefaultDelegate(endpoint, &sAmebaWindowCoveringManager);
