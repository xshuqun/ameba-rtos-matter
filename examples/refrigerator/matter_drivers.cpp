...
CHIP_ERROR matter_driver_refrigerator_set_startup_value(void)
{
    ...
    uint8_t mode = static_cast<uint8_t>(to_underlying(ModeTag::kRapidCool));
    modeChangedResponse.status = to_underlying(refrigeratorObject.UpdateCurrentMode(mode)); // Set refrigerator mode
