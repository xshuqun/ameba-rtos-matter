...
SRC_C += $(SDKROOTDIR)/component/application/matter/examples/chiptest/example_matter.c
SRC_C += $(SDKROOTDIR)/component/application/matter/common/mbedtls/mbedtls_memory.c
...
SRC_CPP += $(SDKROOTDIR)/component/application/matter/core/matter_device_utils.cpp
