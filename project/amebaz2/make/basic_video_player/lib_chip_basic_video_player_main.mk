...
MATTER_DRIVER       = $(MATTER_DIR)/drivers
MATTER_EXAMPLEDIR   = $(MATTER_DIR)/examples
OUTPUT_DIR          = $(MATTER_EXAMPLEDIR)/basic_video_player/build/chip
...
INCLUDES += -I$(MATTER_EXAMPLEDIR)/basic_video_player
...
# basic_video_player-app source files
SRC_CPP += $(MATTER_DRIVER)/device/basic_video_player_driver.cpp
SRC_CPP += $(MATTER_DRIVER)/matter_drivers/media_playback/ameba_media_playback_delegate.cpp
SRC_CPP += $(MATTER_DRIVER)/matter_drivers/keypad_input/ameba_keypad_input_delegate.cpp
SRC_CPP += $(MATTER_EXAMPLEDIR)/basic_video_player/example_matter_basic_video_player.cpp
SRC_CPP += $(MATTER_EXAMPLEDIR)/basic_video_player/matter_drivers.cpp
