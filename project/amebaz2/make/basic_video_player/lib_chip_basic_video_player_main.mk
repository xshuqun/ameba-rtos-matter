...
# -------------------------------------------------------------------
DEVICE_TYPE  := basic_video_player
...
# -------------------------------------------------------------------
SRC_CPP += $(MATTER_DRIVER_DIR)/device/basic_video_player_driver.cpp
SRC_CPP += $(MATTER_DRIVER_DIR)/matter_drivers/media_playback/ameba_media_playback_delegate.cpp
SRC_CPP += $(MATTER_DRIVER_DIR)/matter_drivers/keypad_input/ameba_keypad_input_delegate.cpp
