...
OUTPUT_DIR          = $(MATTER_EXAMPLEDIR)/hvac_device/build/chip
...
INCLUDES += -I$(MATTER_EXAMPLEDIR)/hvac_device
...
SRC_CPP += $(MATTER_DIR)/core/matter_core.cpp
SRC_CPP += $(MATTER_DIR)/core/matter_data_model.cpp
SRC_CPP += $(MATTER_DIR)/core/matter_data_model_presets.cpp
SRC_CPP += $(MATTER_DIR)/core/matter_interaction.cpp
ifeq ($(CHIP_ENABLE_OTA_REQUESTOR), true)
SRC_CPP += $(MATTER_DIR)/core/matter_ota_initializer.cpp
endif

SRC_CPP += $(MATTER_DRIVER)/fan/ameba_fan_stubs.cpp

# example entrance
SRC_CPP += $(MATTER_EXAMPLEDIR)/hvac_device/example_matter_hvac_device.cpp

# driver configurations
SRC_CPP += $(MATTER_EXAMPLEDIR)/hvac_device/matter_drivers.cpp

# thermostat-app source files
SRC_CPP += $(MATTER_DIR)/drivers/device/thermostat_driver.cpp
SRC_CPP += $(MATTER_DIR)/drivers/device/thermostat_ui_driver.cpp

# fan-app source files
SRC_CPP += $(MATTER_DIR)/drivers/device/fan_driver.cpp

# aircon-app source files
SRC_CPP += $(MATTER_DIR)/drivers/device/room_aircon_driver.cpp
SRC_CPP += $(MATTER_DIR)/drivers/device/temp_hum_sensor_driver.cpp
