...
OUTPUT_DIR          = $(MATTER_EXAMPLEDIR)/microwave_oven/build/chip
...
INCLUDES += -I$(MATTER_EXAMPLEDIR)/microwave_oven
...
# microwave-oven-app source files
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/device/microwave_oven_driver.cpp
SRC_CPP += $(MATTER_DRIVER)/microwave_oven/ameba_microwave_oven_device.cpp
SRC_CPP += $(MATTER_EXAMPLEDIR)/microwave_oven/example_matter_microwave_oven.cpp
SRC_CPP += $(MATTER_EXAMPLEDIR)/microwave_oven/matter_drivers.cpp
...
clean:
	...
	rm -f *.s
	rm -f $(VER_C)
	rm -rf $(MATTER_MAKEDIR)/microwave_oven/lib_main*
