...
GENERATE_NINJA:
	...
	echo chip_terms_and_conditions_required = "false" >> $(OUTPUT_DIR)/args.gn && \
...
clean:
	echo "RM $(OUTPUT_DIR)"
	rm -rf $(OUTPUT_DIR)
	rm -rf $(MATTER_EXAMPLEDIR)/refrigerator/build
	rm -rf $(MATTER_EXAMPLEDIR)/refrigerator/refrigerator-app.matter
