...
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/drivers/device/temperature_sensor_driver.cpp
SRC_CPP += $(MATTER_EXAMPLEDIR)/temperature_sensor/example_matter_temperature_sensor.cpp
...
clean:
	...
	rm -f *.s
	rm -f $(VER_C)
	rm -rf $(MATTER_MAKEDIR)/temperature_sensor/lib_main*
