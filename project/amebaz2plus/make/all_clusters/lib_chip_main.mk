...
SRC_CPP += $(MATTER_DRIVER)/laundry_washer_mode/ameba_laundry_washer_mode_main.cpp
...
SRC_CPP += $(MATTER_DRIVER)/microwave_oven_mode/ameba_microwave_oven_mode_main.cpp
...
SRC_CPP += $(MATTER_DRIVER)/oven_mode/ameba_oven_mode_main.cpp
...
SRC_CPP += $(MATTER_DRIVER)/refrigerator_mode/ameba_tcc_mode_main.cpp
SRC_CPP += $(MATTER_DRIVER)/rvc_clean_mode/ameba_rvc_clean_mode_delegate.cpp
SRC_CPP += $(MATTER_DRIVER)/rvc_clean_mode/ameba_rvc_clean_mode_main.cpp
SRC_CPP += $(MATTER_DRIVER)/rvc_run_mode/ameba_rvc_run_mode_delegate.cpp
SRC_CPP += $(MATTER_DRIVER)/rvc_run_mode/ameba_rvc_run_mode_main.cpp
...
SRC_CPP += $(MATTER_DRIVER)/water_heater_mode/ameba_water_heater_mode_main.cpp
